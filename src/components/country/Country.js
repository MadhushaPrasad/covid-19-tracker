...
class Country extends React.Component {
  render() {
    return (
      <div className="divCard bg-white card col-lg-3 mr-1 col-md-6 col-sm-6 ">
        <img
        ...
        <div className="card-body text-center">
          ...
          <p className="card-text">tests</p>
          <h5>{this.props.todayCases}</h5>
          <p className="card-text">todayCases</p>
          <h5>{this.props.todayDeaths}</h5>
          <p className="card-text">todayDeaths</p>
          <h5>{this.props.todayRecovered}</h5>
          <p className="card-text">todayRecovered</p>
          <p className="card-text">
            <small className="text-muted">
              Last updatedTime: {this.props.updatedTime}
            </small>
          </p>
        </div>
      </div>
